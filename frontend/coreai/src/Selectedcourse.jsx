...
function Tools(props) {
    ...
    <div style={{
        ...
        <img className="selectedCourseImg" style={{
            width: 'auto' 
        }} src={"../public/images/icon/"+props.title + ' 1'+'.svg'} alt="" />
        <img className="selectedCourseImg" style={{
            width: 'auto'
        }} src={"../public/images/icon/"+props.title + ' 2'+'.svg'} alt="" />
        <img className="selectedCourseImg" style={{
            width: 'auto'
        }} src={"../public/images/icon/"+props.title + ' 3'+'.svg'} alt="" />
        <img className="selectedCourseImg" style={{
            width: 'auto'
        }} src={"../public/images/icon/"+props.title + ' 4'+'.svg'} alt="" />
        <img className="selectedCourseImg" style={{
            width: 'auto'
        }} src={"../public/images/icon/"+props.title + ' 5'+'.svg'} alt="" />
        <img className="selectedCourseImg" style={{
            width: 'auto'
        }} src={"../public/images/icon/"+props.title + ' 6'+'.svg'} alt="" />
        <img className="selectedCourseImg" style={{
            width: 'auto'
        }} src={"../public/images/icon/"+props.title + ' 7'+'.svg'} alt="" />
